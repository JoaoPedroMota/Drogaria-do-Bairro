# Generated by Django 4.1.7 on 2023-05-30 00:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(blank=True, default='', help_text='Estado ou provincia onde reside.', max_length=3, validators=[django.core.validators.RegexValidator('^[A-Za-z]{0,3}$', 'Este campo deve conter apenas letras do alfabeto ocidental e ter no máximo 3 letras.')])),
                ...
                ('imagem_perfil', models.ImageField(default='imagens_perfil\\avatar.png', null=True, upload_to='imagens_perfil/', validators=[loja.models.Utilizador.validar_extensao_imagens, loja.models.Utilizador.validar_tamanho_imagens])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome_morada', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('telemovel', phonenumber_field.modelfields.PhoneNumberField(blank=True, default='', error_messages={'unique': 'Já existe um utilizador com esse número de telefone.'}, help_text='O País default para os números de telemóvel é Portugal(+351). Se o seu número for de um país diferente tem de adicionar o identificador desse país.', max_length=128, region=None)),
                ('email', models.EmailField(blank=True, default='', error_messages={'unique': 'Já existe um utilizador com esse e-mail.'}, max_length=200)),
                ...
                ('consumidor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='detalhes_envio', to='loja.consumidor')),
            ],
        ),
        migrations.CreateModel(
