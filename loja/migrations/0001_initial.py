    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('estado', models.CharField(choices=[('Em processamento', 'Em processamento'), ('Enviado', 'Enviado'), ('Entregue', 'Entregue'), ('Cancelado', 'Cancelado')], default='Em processamento', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_a_granel', models.DecimalField(blank=True, decimal_places=2, help_text='Utilize um ponto, em ve de uma vírgula', max_digits=7, null=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidadeProducao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Encomendas', to='loja.unidadeproducao')),
            ],
            options={
