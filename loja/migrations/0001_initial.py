# Generated by Django 4.2.1 on 2023-06-14 01:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('estado', models.CharField(choices=[('Em processamento', 'Em processamento'), ('Enviado', 'Enviado'), ('A chegar', 'A chegar'), ('Entregue', 'Entregue'), ('Cancelado', 'Cancelado')], default='Em processamento', max_length=20)),
